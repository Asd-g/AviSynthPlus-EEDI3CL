...
void filterCL_avx2(const AVS_VideoFrame* __restrict src, const AVS_VideoFrame* __restrict scp, AVS_VideoFrame* __restrict dst, const int field_n, bool use_dh, EEDI3CLData* __restrict d, const AVS_FilterInfo* __restrict fi)
{
    ...
    for (int plane{ 0 }; plane < avs_num_components(&fi->vi); ++plane)
    {
        if (d->process[plane])
        {
            ...
            const size_t globalWorkSize[]{ static_cast<size_t>((dstWidth + 7) & -8), static_cast<size_t>(d->vectorSize) };
...
template void filterCL_avx2<uint8_t>(const AVS_VideoFrame* __restrict src, const AVS_VideoFrame* __restrict scp, AVS_VideoFrame* __restrict dst, const int field_n, bool use_dh, EEDI3CLData* __restrict d, const AVS_FilterInfo* __restrict fi);
template void filterCL_avx2<uint16_t>(const AVS_VideoFrame* __restrict src, const AVS_VideoFrame* __restrict scp, AVS_VideoFrame* __restrict dst, const int field_n, bool use_dh, EEDI3CLData* __restrict d, const AVS_FilterInfo* __restrict fi);
template void filterCL_avx2<float>(const AVS_VideoFrame* __restrict src, const AVS_VideoFrame* __restrict scp, AVS_VideoFrame* __restrict dst, const int field_n, bool use_dh, EEDI3CLData* __restrict d, const AVS_FilterInfo* __restrict fi);
